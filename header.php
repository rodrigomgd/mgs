    ...
    <div class="row pt-5 pb-5 justify-content-around">
        ...
        <div class="header-social-links">
            ...
            <ul class="list-inline">
                <li class= "list-inline-item"><a target="_blank" href="http://fb.com/agenciamegusta"><img src="<?php echo get_theme_file_uri('assets/img/facebook.png') ?>" alt=""></a></li>
                <li class= "list-inline-item"><a target="_blank" href="http://instagr.am/agenciamegusta/"><img src="<?php echo get_theme_file_uri('assets/img/instagram.png') ?>" alt=""></a></li>
            </ul>
        </div>
    </div>
</div>
